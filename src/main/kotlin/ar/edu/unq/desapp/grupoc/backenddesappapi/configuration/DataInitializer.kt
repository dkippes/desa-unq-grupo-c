...
class DataInitializer {
    ...
    fun initData(
        ...
        // Insert users
        val user1 = User(name = "Marie", lastName = "Doe", email = "marie.doe@example.com", password = "password123!", address = "123 Main St", account = account1)
        val user2 = User(name = "John", lastName = "Doe", email = "john.doe@example.com", password = "password123!", address = "123 Main St", account = account2)
